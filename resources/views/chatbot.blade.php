...
<body class="flex flex-col justify-between h-screen">
	...
	<input
		type="text"
		class="flex-1 border rounded-md m-2
			p-2
			border-transparent"
		placeholder="Chat..."
		name="chat"
		id="chat"
	/>
	<button id="btn" class="m-2  p-2 rounded-md text-white" style="background-color: #333">
		Send
	</button>
	</div>
	...
	<script type="module" src="{{asset('assets/js/chatbot.js')}}"></script>
